...
if (isset($_POST['action']) && $_POST['action'] === 'upload') {
    ...
    try {
        ...
        if ($result === null && json_last_error() !== JSON_ERROR_NONE) {
            throw new Exception('Réponse JSON invalide du serveur : ' . json_last_error_msg());
        }
...
if (isset($_POST['action']) && $_POST['action'] === 'chat') {
    ...
    try {
        ...
        if ($data && isset($data['textResponse'])) {
            ...
            error_log("Invalid response from Symplissime AI: $response");
    ...
    <script>
        ...
        class CROMChat {
            ...
            addMessage(content, isUser = false) {
                ...
                // Smooth scroll to bottom avec requestAnimationFrame
